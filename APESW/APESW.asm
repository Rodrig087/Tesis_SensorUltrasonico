...
;APESW.c,63 :: 		if (contw<=63){                           //Controla el numero total de pulsos de exitacion del transductor ultrasonico. (43)
	MOVLW       0
	MOVWF       R0 
	MOVF        _contw+1, 0 
	SUBWF       R0, 0 
...
;APESW.c,71 :: 		}
L_Interrupt2:
;APESW.c,72 :: 		if ((contw==14)||(contw==31)||(contw==48)){                        //Cambia el valor de la variable auxiliar para producir  (22)
	MOVLW       0
	XORWF       _contw+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__Interrupt24
