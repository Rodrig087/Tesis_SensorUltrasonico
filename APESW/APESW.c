...
//Interrupcion TIMER 2:
    if (TMR2IF_bit){                             //Verifica si ocurrio una interrupcion por desbordamiento del TMR2.
       ...
       if (contw<=63){                           //Controla el numero total de pulsos de exitacion del transductor ultrasonico. (43)
          ...
          if ((contw==14)||(contw==31)||(contw==48)){                        //Cambia el valor de la variable auxiliar para producir  (22)
