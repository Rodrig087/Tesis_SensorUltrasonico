...
;ADC_DAC.c,396 :: 		}
	GOTO	L_main49
L_main50:
;ADC_DAC.c,397 :: 		for (ipp=0;ipp<Psize;ipp++){
	MOV	#lo_addr(_ipp), W1
	CLR	W0
	MOV.B	W0, [W1]
L_main52:
	...
	GOTO	L_main53
L__main114:
;ADC_DAC.c,398 :: 		Ptcn[ipp]=0;                           //Limpia la trama de peticion
	MOV	#lo_addr(_ipp), W0
	ZE	[W0], W1
	MOV	#lo_addr(_Ptcn), W0
	ADD	W0, W1, W1
...
L__main79:
L__main78:
;ADC_DAC.c,410 :: 		for (ipp=0;ipp<Psize;ipp++){
	MOV	#lo_addr(_ipp), W1
	CLR	W0
	MOV.B	W0, [W1]
L_main59:
	...
	GOTO	L_main60
L__main116:
;ADC_DAC.c,411 :: 		Ptcn[ipp]=0;                           //Limpia la trama de peticion
	MOV	#lo_addr(_ipp), W0
	ZE	[W0], W1
	MOV	#lo_addr(_Ptcn), W0
	ADD	W0, W1, W1
