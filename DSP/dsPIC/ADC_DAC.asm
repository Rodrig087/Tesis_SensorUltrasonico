...
;ADC_DAC.c,203 :: 		if ((T2b-T2a)<=T2umb){             //Verifica si el T2 actual esta dentro de un umbral pre-establecido
	...
	CP0	W0
	CLR.B	W0
	BRA GT	L__Distancia67
	INC.B	W0
L__Distancia67:
	CP0.B	W0
	BRA NZ	L__Distancia68
	GOTO	L_Distancia17
L__Distancia68:
...
;ADC_DAC.c,233 :: 		if ((Dato==Hdr)&&(ip==0)){                    //Verifica que el primer dato en llegar sea el identificador de inicio de trama
	...
	GOTO	L__UART1Interrupt52
L__UART1Interrupt71:
	MOV	#lo_addr(_ip), W0
	MOV.B	[W0], W0
	CP.B	W0, #0
	BRA Z	L__UART1Interrupt72
	GOTO	L__UART1Interrupt51
L__UART1Interrupt72:
L__UART1Interrupt50:
...
;ADC_DAC.c,240 :: 		if ((BanT==1)&&(ip!=0)){
	...
	MOV.B	[W0], W0
	CP.B	W0, #1
	BRA Z	L__UART1Interrupt75
	GOTO	L__UART1Interrupt56
L__UART1Interrupt75:
	MOV	#lo_addr(_ip), W0
	MOV.B	[W0], W0
	CP.B	W0, #0
	BRA NZ	L__UART1Interrupt76
