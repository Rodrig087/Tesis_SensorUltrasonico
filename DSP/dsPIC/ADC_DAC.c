...
1.
---------------------------------------------------------------------------------------------------------------------------*/
//Funcion de transferencia h(n) filtro FIR (Fs=200KHz, Fc=5547Hz) Ventana Blackman
const float h[]=
{
0,			//h(0)
3.251384999241953e-04,	//h(1)
0.001575110004776,	//h(2)
0.004329299981286,	//h(3)
0.009215597951451,	//h(4)
0.016562374380979,	//h(5)
0.026042906090692,	//h(6)
0.036510596395369,	//h(7)
0.046158863555439,	//h(8)
0.052995863262555,	//h(9)
0.055470000000000,	//h(10)
0.052995863262555,	//h(11)
0.046158863555439,	//h(12)
0.036510596395369,	//h(13)
0.026042906090692,	//h(14)
0.016562374380979,	//h(15)
0.009215597951451,	//h(16)
0.004329299981286,	//h(17)
0.001575110004776,	//h(18)
3.251384999241943e-04,	//h(19)
0			//h(20)
};
...
void Timer1Interrupt() iv IVT_ADDR_T1INTERRUPT{
     ...
     if (bm==3) {                                  //Cuando la bandera bm=3, la interrupcion por TMR1 es utilizada para la reconstruccion de la señal mediante el DAC
          if (j<nm){
             //LATB = (M[j]&0x00FF)<<8;
             j++;
          } else {
