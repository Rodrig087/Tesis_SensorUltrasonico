...
;Splitter.c,49 :: 		if(PIR1.F5==1){                                 //Verifica la bandera de interrupcion del Uart1
	BTFSS       PIR1+0, 5 
	GOTO        L_interrupt0
;Splitter.c,56 :: 		dato = UART1_Read();
	CALL        _UART1_Read+0, 0
	MOVF        R0, 0 
	MOVWF       _dato+0 
;Splitter.c,57 :: 		BanP=1;
	MOVLW       1
	MOVWF       _BanP+0 
;Splitter.c,58 :: 		PIR1.F5 = 0;                            //Limpia la bandera de interrupcion
	BCF         PIR1+0, 5 
;Splitter.c,59 :: 		}
L_interrupt0:
;Splitter.c,60 :: 		}
...
;Splitter.c,108 :: 		}
	GOTO        L_main7
L_main8:
;Splitter.c,109 :: 		Dst = 0;
	CLRF        _Dst+0 
	CLRF        _Dst+1 
;Splitter.c,111 :: 		} else if (RA0_bit==0){
	GOTO        L_main10
L_main6:
...
L_main11:
L_main10:
;Splitter.c,141 :: 		if (BanP==1){
	MOVF        _BanP+0, 0 
	XORLW       1
	BTFSS       STATUS+0, 2 
	GOTO        L_main12
;Splitter.c,142 :: 		Dst = Dst+1;
	INFSNZ      _Dst+0, 1 
	INCF        _Dst+1, 1 
;Splitter.c,143 :: 		BanP=0;
	CLRF        _BanP+0 
;Splitter.c,144 :: 		}
L_main12:
;Splitter.c,147 :: 		IntToStr(Dst,txt1);
	MOVF        _Dst+0, 0 
	...
	CALL        _IntToStr+0, 0
;Splitter.c,149 :: 		Lcd_Out(1,1,"Distancia:");
	MOVLW       1
	...
	CALL        _Lcd_Out+0, 0
;Splitter.c,150 :: 		Lcd_Out(2,1,txt1);
	MOVLW       2
	MOVWF       FARG_Lcd_Out_row+0 
	MOVLW       1
	MOVWF       FARG_Lcd_Out_column+0 
