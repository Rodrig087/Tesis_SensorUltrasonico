...
;Splitter.c,104 :: 		ptrDst = &Dst;
	MOVLW       _Dst+0
	MOVWF       _ptrDst+0 
	MOVLW       hi_addr(_Dst+0)
	MOVWF       _ptrDst+1 
;Splitter.c,106 :: 		Ptcn[0]=Hdr;
	MOVLW       238
	MOVWF       _Ptcn+0 
;Splitter.c,107 :: 		Ptcn[1]=Tp;
	MOVLW       1
	MOVWF       _Ptcn+1 
;Splitter.c,108 :: 		Ptcn[2]=Id;
	MOVLW       7
	MOVWF       _Ptcn+2 
;Splitter.c,109 :: 		Ptcn[3]=End;
	MOVLW       255
	MOVWF       _Ptcn+3 
;Splitter.c,111 :: 		Bb=0;
	CLRF        _Bb+0 
;Splitter.c,112 :: 		Dst=0;
	CLRF        _Dst+0 
	CLRF        _Dst+1 
;Splitter.c,114 :: 		while (1){
L_main12:
;Splitter.c,116 :: 		if ((RA0_bit==1)&&(Bb==0)){
...
;Splitter.c,117 :: 		Bb = 1;
	MOVLW       1
	MOVWF       _Bb+0 
;Splitter.c,118 :: 		for (ip=0;ip<Psize;ip++){
	CLRF        _ip+0 
L_main17:
	MOVLW       128
	XORWF       _ip+0, 0 
	...
	BTFSC       STATUS+0, 0 
	GOTO        L_main18
;Splitter.c,119 :: 		UART1_WRITE(Ptcn[ip]);                          //Manda por Uart la trama de peticion
	MOVLW       _Ptcn+0
	MOVWF       FSR0 
...
;Splitter.c,120 :: 		}
	GOTO        L_main17
L_main18:
;Splitter.c,121 :: 		Dst = 0;
	CLRF        _Dst+0 
	CLRF        _Dst+1 
;Splitter.c,123 :: 		} else if (RA0_bit==0){
	GOTO        L_main20
L_main16:
...
L_main21:
L_main20:
;Splitter.c,127 :: 		if (BanP==1){
	MOVF        _BanP+0, 0 
	XORLW       1
	BTFSS       STATUS+0, 2 
	GOTO        L_main22
;Splitter.c,128 :: 		if ((Rspt[0]==Hdr)&&(Rspt[Rsize-1]==End)){
	MOVF        _Rspt+0, 0 
	XORLW       238
	BTFSS       STATUS+0, 2 
	GOTO        L_main25
	...
	GOTO        L_main25
L__main44:
;Splitter.c,129 :: 		if ((Rspt[1]==TP)&&(Rspt[2]==Id)){                //Verifica el identificador de tipo de sensor y el identificador de esclavo
	MOVF        _Rspt+1, 0 
	XORLW       1
	BTFSS       STATUS+0, 2 
	GOTO        L_main28
	...
	GOTO        L_main28
L__main43:
;Splitter.c,131 :: 		for (irr=3;irr<5;irr++){
	MOVLW       3
	MOVWF       _irr+0 
L_main29:
	MOVLW       128
	...
	BTFSC       STATUS+0, 0 
	GOTO        L_main30
;Splitter.c,132 :: 		*(ptrDst+(irr-3)) = Rspt[irr];               //Asigna a TT2 los datos tomados de la trama de peticion
	MOVLW       3
	SUBWF       _irr+0, 0 
	MOVWF       R0 
	MOVLW       0
...
;Splitter.c,133 :: 		}
	GOTO        L_main29
L_main30:
;Splitter.c,134 :: 		for (irr=0;irr<(Rsize-1);irr++){
	CLRF        _irr+0 
L_main32:
	MOVLW       128
	XORWF       _irr+0, 0 
	...
	BTFSC       STATUS+0, 0 
	GOTO        L_main33
;Splitter.c,135 :: 		Rspt[irr]=0;;                            //Limpia los bits de datos de la trama de respuesta
	MOVLW       _Rspt+0
	MOVWF       FSR1 
	MOVLW       hi_addr(_Rspt+0)
	MOVWF       FSR1H 
...
;Splitter.c,140 :: 		} else {
	GOTO        L_main35
L_main25:
;Splitter.c,142 :: 		for (irr=0;irr<(Rsize-1);irr++){
	CLRF        _irr+0 
L_main36:
	MOVLW       128
	XORWF       _irr+0, 0 
	...
	BTFSC       STATUS+0, 0 
	GOTO        L_main37
;Splitter.c,143 :: 		Rspt[irr]=0;;                            //Limpia los bits de datos de la trama de respuesta
	MOVLW       _Rspt+0
	MOVWF       FSR1 
	MOVLW       hi_addr(_Rspt+0)
	MOVWF       FSR1H 
...
;Splitter.c,144 :: 		}
	GOTO        L_main36
L_main37:
;Splitter.c,145 :: 		BanP = 0;
	CLRF        _BanP+0 
;Splitter.c,147 :: 		}
L_main35:
;Splitter.c,148 :: 		}
L_main22:
;Splitter.c,151 :: 		IntToStr(Dst,txt1);
	MOVF        _Dst+0, 0 
	...
	CALL        _IntToStr+0, 0
;Splitter.c,153 :: 		Lcd_Out(1,1,"Distancia:");
	MOVLW       1
	...
	CALL        _Lcd_Out+0, 0
;Splitter.c,154 :: 		Lcd_Out(2,1,txt1);
	MOVLW       2
	MOVWF       FARG_Lcd_Out_row+0 
	MOVLW       1
	MOVWF       FARG_Lcd_Out_column+0 
